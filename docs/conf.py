...
html_title = 'QMWorks Documentation'
...
texinfo_documents = [
    (master_doc, 'nac', 'nac Documentation',
     author, 'nac', 'One line description of project.',
     'Miscellaneous'),
]
