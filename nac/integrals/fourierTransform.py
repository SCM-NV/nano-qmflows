...
def get_fourier_basis(atomic_symbols: Vector, dictCGFs: Dict, kpoints: Vector):
    """
    for each element in system compute Fourier transfroms of its basis functions
    in given set of k-points and store them into dictionary
    """
...
def calculate_fourier_trasform_contracted(cgf: NamedTuple, ks: Vector) -> complex:
    """
    Compute 3D Fourier transform for given basis function "cgf" composed of gaussian
    primitives for set of kpoints "ks"
    """
