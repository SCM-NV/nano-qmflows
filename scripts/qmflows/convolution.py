    ...
    if write:
       ...
       if nm:
          ...
          output = output[::-1]
           ...
           header = fmt.format(
                'eV', 'f')
       np.savetxt('convolution.txt', output,fmt='%11.3f %10.5f', header=header)
...
if __name__ == "__main__":
    ...
    msg = "convolution.py -sigma <sigma parameter of the gaussian functions> -n <plot only the spectrum of structure n> -nm <plot in nm> -write <write the coordinates from the convolution>"
