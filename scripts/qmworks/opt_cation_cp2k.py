#! /usr/bin/env python
"""
This programs performs a geometry optimization of the cation of a closed-shell molecule with cp2k using generic settings: DFT/PBE. 
...
It assumes that the basis and pot files are in $HOME/cp2k_basis folder in your home, which can be changed) 
...
from qmworks import Settings, cp2k, run, templates
...
if __name__ == "__main__":
    ...
    parser.add_argument('-basis',  type=str, default='DZVP-MOLOPT-SR-GTH', help='Basis-set name')
    parser.add_argument('-bas_fold', type=str, default=join(home,'cp2k_basis'), help='Location of basis set files')
