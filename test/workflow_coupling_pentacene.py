...
def main():
    plams.init()
    project_name = 'test_pentacene'

    # create Settings for the Cp2K Jobs
    cp2k_args = Settings()
    cp2k_args.basis = "DZVP-MOLOPT-SR-GTH"
    cp2k_args.potential = "GTH-PBE"
    cp2k_args.cell_parameters = [[16.11886919,0.07814137,-0.697284243],[-0.215317662, 4.389405268, 1.408951791], [-0.216126961,	1.732808365, 9.748961085]]
    ...
    path_traj_xyz = "./test_files/traj_12_points.xyz"

    # Work_dir
    work_dir = os.path.realpath('.')
    
    # HDF5 path
    path_hdf5 = 'quantum.hdf5'
    ...
    #Assert Results
    with h5py.File('quantum.hdf5', 'r') as f1, \
         h5py.File('./test_files/pentacene_test.hdf5', 'r') as f2:
         dset1 = f1[join(work_dir, 'coupling_9')]
         dset2 = f2['nfs/home6/fza900/pentacene/test/test_pentacene/coupling_9']
    arr1 = dset1[...]
    arr2 = dset2[...]
